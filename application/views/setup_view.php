...
<head>
    ...
    <title>Setup - Warnet Ezezet</title>
            ...
            <div>
                <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                    <form role="form" action="<?php echo base_url() ?>setup/submit" method="post" class="f1">
                        ...
                        <h3>Setup Aplikasi Billing Warnet</h3>
                        ...
                        <fieldset>
                            ...
                            <p>
                                ...
                                karena telah memilih warnet "Ezezet". Silahkan memulai dengan mengisi
                                data anda. Selamat Menggunakan.
                            </p>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="Nama Warnet" class="f1-first-name form-control" id="f1-first-name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="about" placeholder="Tentang" class="f1-about-yourself form-control" id="f1-about-yourself"></textarea>
                            </div>
                            <div class="f1-buttons">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" placeholder="Password" class="f1-repeat-password form-control" id="f1-repeat-password">
                            </div>
                            <div class="f1-buttons">
                                <button type="button" class="btn btn-previous">Previous</button>
