...
<head>
    ...
    <title><?php echo $title ?> | Ezezet</title>
    <!-- Bootstrap -->
        ...
        <div class="main_container">
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="#" class="site_title"><span>Ezezet</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url() ?>pc"><i class="fa fa-book"></i> PC</a>
                                </li>
                        ...
                        <?php if ($this->session->userdata('role') == 'admin') : ?>
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li>
                                        <a href="<?php echo base_url() ?>pemakaian"><i class="fa fa-arrow-up"></i> Pemakaian</a>
                                    </li>
                                    <li>
            ...
            <footer>
                <div class="pull-right">
                    Warnet Ezezet v0.1 Alpha | Copyright Alif Software
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
