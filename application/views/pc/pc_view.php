<div class="">
    <div class="page-title" style="padding: 8px">
        <div class="title_left">
            <h1><i class="fa fa-book"></i>Data PC</h1>
        </div>
    </div>
    <?php if ($this->session->userdata('role') == 'superadmin') : ?>
        <a href="<?php echo base_url() ?>pc/add" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Tambah PC</a>
    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>List Data <small>PC</small></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <!-- Notif -->
                            ...
                            <tbody>
                                ...
                                <?php foreach ($list as $bookList) : ?>
                                    <tr>
                                        ...
                                        <?php if ($this->session->userdata('role') == 'superadmin') : ?>
                                            <td>
                                                <a href="<?php echo base_url() ?>pc/edit?idtf=<?php echo $bookList->ID_PC ?>" class="btn btn-info btn-xs">
...
<script>
    function sweets() {
        swal({
            ...
            function() {
                window.location.href = "<?php echo base_url() ?>pc/delete?rcgn=<?php echo $bookList->ID_PC ?>";
            });
    }
</script>